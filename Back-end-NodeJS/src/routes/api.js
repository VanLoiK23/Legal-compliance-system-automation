...
const { saveComplianceResult, getAllResults, getResultById, deleteResult, getStats, checkDuplicate } = require('../controllers/complianceController');
...
router.post('/compliance-results/check-duplicate', checkDuplicate);
